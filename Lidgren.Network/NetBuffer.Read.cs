...
namespace Lidgren.Network
{
    ...
    public partial class NetBuffer
    {
        ...
        {
            Assert(m_bitLength - m_readPosition >= 8, c_readOverflowError);
        ...
        {
            Assert(numberOfBits > 0 && numberOfBits <= 8, "ReadByte(bits) can only read between 1 and 8 bits");
        ...
        {
            Assert(m_bitLength - m_readPosition + 7 >= (numberOfBytes * 8), c_readOverflowError);
        ...
        {
            Assert(m_bitLength - m_readPosition + 7 >= (numberOfBytes * 8), c_readOverflowError);
            Assert(offset + numberOfBytes <= into.Length);
        ...
        {
            Assert(m_bitLength - m_readPosition >= numberOfBits, c_readOverflowError);
            Assert(offset + NetUtility.BytesToHoldBits(numberOfBits) <= into.Length);
        ...
        {
            Assert(m_bitLength - m_readPosition >= 16, c_readOverflowError);
        ...
        {
            Assert(m_bitLength - m_readPosition >= 32, c_readOverflowError);
        ...
        {
            Assert(numberOfBits > 0 && numberOfBits <= 32, "ReadInt32(bits) can only read between 1 and 32 bits");
            Assert(m_bitLength - m_readPosition >= numberOfBits, c_readOverflowError);
        ...
        {
            Assert(numberOfBits > 0 && numberOfBits <= 32, "ReadUInt32(bits) can only read between 1 and 32 bits");
            //Assert(m_bitLength - m_readBitPtr >= numberOfBits, "tried to read past buffer size");
        ...
        {
            Assert(numberOfBits > 0 && numberOfBits <= 64, "ReadUInt64(bits) can only read between 1 and 64 bits");
            Assert(m_bitLength - m_readPosition >= numberOfBits, c_readOverflowError);
        ...
        {
            Assert(((numberOfBits > 0) && (numberOfBits <= 64)), "ReadInt64(bits) can only read between 1 and 64 bits");
